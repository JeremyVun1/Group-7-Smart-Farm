...
class Voltage {
    ...
    function addReading() {
        $stmt = $this->conn->prepare("INSERT INTO $this->table_name (sensor_id, voltage, datetime) VALUES (?, ?, ?)");
    ...
    function getReadings($id, $start, $end) {
        $stmt = "SELECT sensor_id, voltage, datetime FROM $this->table_name";
