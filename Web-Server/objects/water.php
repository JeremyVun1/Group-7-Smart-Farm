...
class Water {
    ...
    function addReading() {
        $stmt = $this->conn->prepare("INSERT INTO $this->table_name (sensor_id, water_level, datetime) VALUES (?, ?, ?)");
    ...
    function getReadings($id, $start, $end) {
        $stmt = "SELECT sensor_id, water_level, datetime FROM $this->table_name";
